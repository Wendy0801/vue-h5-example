...
const social = {
    ...
    goAppShare(data){  // app的分享
        let shareUrl = data.link;
        let title = data.title;
        let describe = data.desc;
        let imageUrl = data.imgUrl;
        window.location = `smilife://shareSomething?shareUrl=${shareUrl}&title=${title}&describe=${describe}&imageUrl=${imageUrl}`
    },
    mapGuide:function(data){
